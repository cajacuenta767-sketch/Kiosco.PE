...
- **Paquetes:** si el producto tiene six-pack o docena, un botoncito bajo el precio cobra el paquete y descuenta sus unidades.
- **Lo de siempre (👤):** toca al cliente y su compra habitual entra al carrito; se aprende sola de lo que fía.
- **Cobrar:** elige método (Efectivo / Yape / Plin / Tarjeta / Fiado).
  ...
  - Yape / Plin: aparece el QR y el número de la bodega; "Mostrar al cliente en grande" llena la pantalla con el QR y el monto para que escanee.
