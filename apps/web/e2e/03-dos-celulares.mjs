...
await A.getByPlaceholder('9xxxxxxxx').fill('911222333')
await A.getByLabel('PIN de la cuenta').fill('4321')
await A.getByLabel('Repite el PIN').fill('4321')
...
await B.getByRole('button', { name: /Ya tengo cuenta: entrar/ }).click()
await B.getByRole('button', { name: /Con código del otro celular/ }).click()
